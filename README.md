...
1. If you cannot follow 2., then make sure to send your RFC for review so late that nobody has time to review it (sending it after the project is actually implemented works perfectly).
